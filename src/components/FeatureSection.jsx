  ...
  return (
    <div className="relative mt-20 border-b border-neutral-800 min-h-[800px]">
      <div className="text-center">
        <span className="bg-[#004AAD] text-[#101720] rounded-full h-6 text-sm font-medium px-2 py-1 uppercase">
          Feature
        </span>
      ...
      <div className="flex flex-wrap mt-10 lg:mt-20">
        {features.map((feature, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3">
            <div className="flex">
              <div className="flex mx-6 h-10 w-10 p-2 bg-[#004AAD] text-[#101720] justify-center items-center rounded-full">
                {feature.icon}
              </div>
              <div>
